...
//         uint160 permissions = (uint160(Hooks.BEFORE_REMOVE_LIQUIDITY_FLAG | Hooks.AFTER_REMOVE_LIQUIDITY_FLAG));
...
//         address govToken = address(0x1);

//         vm.broadcast();
//         Counter counter = new Counter{salt: salt}(manager, govToken);
